...
from app.untils.common import check_and_video_type
class ExternaVideo(View):
    ...
    def get(self,request):
        ...
        data={'error':error}
        videos=Video.objects.exclude(from_to=FromType.custom.value)#拿除了自制以外的视频
        data['videos']=videos
...
class VideoSubView(View):
    ...
    def post(self,request,video_id):
        ...
        try:
            ...
            return redirect('{}?error={}'.format(reverse(path_format,'创建失败')))
